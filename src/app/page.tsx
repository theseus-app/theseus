...
export default function StudyBuilderPage() {
  ...
  return (
    <div className="flex flex-col max-w-[1440px] mx-auto">
      <Header setDto={setDto} setOpen={setOpen} />
      <main className="min-h-screen bg-gray-100">
        {/* name */}
        <NameSection dto={dto} set={set} />
        ...
        <div className="pt-6 space-y-6 px-4">
            ...
            <div className="space-y-3">
              ...
              <SectionCard title=" Propensity Score Adjustment">
                <ArrayHeader
                  ...
                  onAdd={() => set("propensityScoreAdjustment", {
                ...
                <div className="space-y-3">
                  {dto.propensityScoreAdjustment.matchOnPsArgs.map((m, i) => (
                    <RowCard
                      key={i}
                      onRemove={() => set("propensityScoreAdjustment", {
                        ...dto.propensityScoreAdjustment,
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  <Field label="maxCohortSizeForFitting (number)">
                    <NumInput
                      ...
                      onChange={(e) => set("propensityScoreAdjustment", {
                        ...dto.propensityScoreAdjustment,
                        createPsArgs: {
                  ...
                  <Field label="errorOnHighCorrelation (boolean)">
                    <Checkbox
                      ...
                      onChange={(v) => set("propensityScoreAdjustment", {
                        ...dto.propensityScoreAdjustment,
                  ...
                  <Field label="control.cvType (enum)">
                    <Select
                      ...
                      onChange={(v: CvType) => set("propensityScoreAdjustment", {
                        ...dto.propensityScoreAdjustment,
                        createPsArgs: {
                          ...dto.propensityScoreAdjustment.createPsArgs,
                  ...
                  <Field label="control.noiseLevel (enum)">
                    <Select
                      ...
                      onChange={(v: NoiseLevel) => set("propensityScoreAdjustment", {
                        ...dto.propensityScoreAdjustment,
                        createPsArgs: {
                          ...dto.propensityScoreAdjustment.createPsArgs,
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <Field label="prior.useCrossValidation (boolean)">
                    <Checkbox
                      ...
                      onChange={(v) => set("fitOutcomeModelArgs", {
                  ...
                  <Field label="control.tolerance (number)">
                    <NumInput
                      ...
                      onChange={(e) => set("fitOutcomeModelArgs", {
                        ...dto.fitOutcomeModelArgs,
                  ...
                  <Field label="control.cvType (enum)">
                    <Select
                      ...
                      onChange={(v: CvType) => set("fitOutcomeModelArgs", {
                        ...dto.fitOutcomeModelArgs,
                  ...
                  <Field label="control.noiseLevel (enum)">
                    <Select
                      ...
                      onChange={(v: NoiseLevel) => set("fitOutcomeModelArgs", {
                        ...dto.fitOutcomeModelArgs,
          ...
          <SectionCard title="Preview & Export" topGroup>
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 rounded-[2px] border bg-white hover:bg-gray-50" onClick={copy}>
                Copy JSON
              </button>
              <button className="px-4 py-2 rounded-[2px] bg-blue-600 text-white hover:bg-blue-700" onClick={() => setOpen(true)}>
                Export
              </button>
            </div>
          </SectionCard>
